...
CREATE TABLE tossup (
  id CHAR(32) PRIMARY KEY,
  question NVARCHAR(700), -- this is extra big for passages, if you don't want to search by the text in this field, you might consider moving to a binary data type instead
